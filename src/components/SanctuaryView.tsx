...
export default function SanctuaryView({
  ...
  return (
    <div className="bg-gradient-to-tr from-[#111] via-[#121614] to-[#111] text-[#e5e2e1] min-h-screen pt-12 pb-24 font-sans relative">
      {/* Toast Alert */}
      <AnimatePresence>
        {sanctuaryToast && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed top-28 left-1/2 -translate-x-1/2 z-[100] bg-[#1e1e1e] border border-[#c8a45d]/60 text-[#e8c177] font-semibold text-xs tracking-wider uppercase px-6 py-3 rounded-md shadow-2xl flex items-center gap-3"
          >
            <Sparkles className="w-4 h-4 text-[#e8c177] animate-spin" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 mt-8">
        ...
        <div className="md:hidden mb-10">
          ...
          <select 
            ...
            className="w-full bg-[#1e1e1e] border border-[#4d4639]/40 rounded px-4 py-3 text-xs font-mono text-[#e8c177] focus:ring-1 focus:ring-[#c8a45d] outline-none"
          >
        ...
        <div className="flex flex-col md:flex-row gap-12 lg:gap-20">
          ...
          <aside className="hidden md:block w-64 shrink-0">
            <div className="sticky top-32 space-y-8">
              <div>
                <span className="text-[10px] font-mono tracking-[0.25em] text-[#9a8f80] uppercase block mb-4 pb-2 border-b border-[#4d4639]/20">
                  YOUR SANCTUARY
                </span>
                <nav className="flex flex-col gap-1">
                  <button 
                    ...
                    className={`flex items-center gap-3.5 px-4 py-3 text-xs uppercase tracking-wider font-mono font-medium rounded transition-all text-left ${
                      activeTab === 'overview' 
                        ? 'bg-[#24523a]/30 text-[#e8c177] border-l-2 border-[#e8c177]' 
                        : 'text-[#9a8f80] hover:text-[#e5e2e1] hover:bg-[#1e1e1e]/45'
                    }`}
                  >
              ...
              <div className="pt-4 border-t border-[#4d4639]/20">
                <button 
                  onClick={() => {
                    if (onLogout) {
                      onLogout();
            ...
            <AnimatePresence mode="wait">
              ...
              {activeTab === 'overview' && (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8 bg-[#1e1e1e]/30 p-8 rounded-lg border border-[#4d4639]/10">
                    <div className="relative">
                      <div className="w-28 h-28 rounded-full overflow-hidden border-2 border-[#c8a45d] p-0.5 bg-[#1a1a1a]">
                        <img 
                    ...
                    <div className="text-center sm:text-left space-y-2">
                      ...
                      <h1 className="font-display text-3xl md:text-4xl text-[#e8c177]">
                  ...
                  <div className="relative p-8 rounded-xl border border-[#c8a45d]/20 bg-[#1e1e1e] overflow-hidden shadow-xl">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-[#c8a45d]/5 rounded-full blur-3xl pointer-events-none -translate-x-1/2 -translate-y-1/2"></div>
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 relative z-10">
                      <div>
                        <span className="text-[10px] font-mono tracking-[0.2em] text-[#e8c177] uppercase block mb-1 flex items-center gap-2">
                          <Sparkles className="w-3.5 h-3.5 text-[#e8c177]" /> SATTVA POINTS BALANCE
                        </span>
                        <div className="font-display text-4xl md:text-5xl text-[#e5e2e1] font-semibold mt-1">
                        ...
                        <p className="font-sans text-xs text-[#d1c5b4] mt-2">
                          Current Status: <span className="text-[#e8c177] font-semibold">Gold Radiance Tier</span>. Just <span className="text-emerald-400 font-bold">550 points</span> until ultimate botanical enlightenment rewards.
                        </p>
                      </div>
                      <button 
                        onClick={() => setRedeemModalOpen(true)}
                        className="bg-[#c8a45d] hover:bg-[#ffdea3] text-[#261900] text-[11px] font-mono uppercase tracking-widest font-bold px-6 py-3.5 rounded transition-all w-full sm:w-auto text-center cursor-pointer shadow-md"
                      >
                        Redeem Wisdom
                      </button>
                    </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {/* Active sub */}
                    <div className="bg-[#1e1e1e]/40 p-6 rounded-lg border border-[#4d4639]/15 space-y-4">
                      <div className="flex justify-between items-center pb-2 border-b border-[#4d4639]/10">
                        <span className="text-[10px] font-mono tracking-widest uppercase text-[#9a8f80]">Active Ritual</span>
                        <button onClick={() => setActiveTab('subscriptions')} className="text-xs text-[#e8c177] hover:underline flex items-center gap-1">
                      ...
                      <div className="flex items-center gap-4">
                        <img 
                          ...
                          alt="Ashwa" 
                          className="w-16 h-16 rounded object-cover filter brightness-90 border border-[#4d4639]/20"
                        />
                        <div>
                          <h4 className="text-xs font-semibold text-[#e5e2e1] uppercase tracking-wider">Ashwagandha Root Elixir</h4>
                    ...
                    <div className="bg-[#1e1e1e]/40 p-6 rounded-lg border border-[#4d4639]/15 space-y-4">
                      <div className="flex justify-between items-center pb-2 border-b border-[#4d4639]/10">
                        ...
                        <button onClick={() => setActiveTab('orders')} className="text-xs text-[#e8c177] hover:underline flex items-center gap-1">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between items-start">
                          <div>
                            <span className="text-xs font-bold text-[#e5e2e1]">Order #AV-88392</span>
                        ...
                        <button 
                          ...
                          className="w-full bg-[#1e1e1e] border border-[#c8a45d]/30 text-xs text-[#e8c177] hover:bg-[#c8a45d]/10 py-2 rounded text-center transition-all cursor-pointer inline-flex items-center justify-center gap-2 font-mono"
                        >
                  ...
                  {/* Curated quote block */}
                  <div className="p-8 border-l-2 border-[#c8a45d] bg-[#1c1b1b]/30 italic text-[#9a8f80] text-xs leading-relaxed rounded">
                    ...
                    <span className="block not-italic text-[10px] uppercase font-mono tracking-widest text-[#e8c177] mt-3">— Ayurvedic Sutras section XVII</span>
                  </div>
              ...
              {activeTab === 'orders' && (
                <motion.div 
                  ...
                  className="space-y-8"
                >
                  <div className="pb-4 border-b border-[#4d4639]/20 flex justify-between items-end">
                    <div>
                      <span className="text-[10px] font-mono tracking-[0.25em] text-[#9a8f80] uppercase">HISTORIC TRANSACTIONS</span>
                      <h2 className="font-display text-2xl md:text-3xl text-[#e5e2e1]">Recent Journeys</h2>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    {orders.map(order => {
                      ...
                      return (
                        <div key={order.id} className="p-6 bg-[#1e1e1e] rounded-lg border border-[#4d4639]/15 flex flex-col md:flex-row justify-between md:items-center gap-6">
                          <div className="space-y-2 max-w-xl">
                            <div className="flex items-center gap-3">
                              <span className="font-mono text-xs font-bold text-[#e8c177] tracking-wider uppercase">Order #{order.id}</span>
                              <span className="text-[10px] text-[#9a8f80] font-mono">{order.date}</span>
                            </div>
                            <h4 className="text-sm font-semibold text-[#e5e2e1]">{order.items}</h4>
                            <p className="text-xs text-[#9a8f80]">Value: <span className="text-[#e8c177] font-bold">{order.total}</span> • Safe checkout logs verified.</p>
                          </div>
                          ...
                          <div className="flex flex-col sm:flex-row gap-3 md:shrink-0">
                            {isShipped ? (
                              ...
                              <button 
                                ...
                                className="bg-[#1c1b1b] border border-[#c8a45d]/40 text-[#e8c177] hover:bg-[#c8a45d]/15 px-5 py-2.5 rounded text-xs font-mono uppercase tracking-widest transition-all cursor-pointer flex items-center justify-center gap-2"
                              >
                                Buy Again
                              </button>
                            )}
              ...
              {activeTab === 'subscriptions' && (
                <motion.div 
                  ...
                  className="space-y-8"
                >
                  <div className="pb-4 border-b border-[#4d4639]/20">
                    <span className="text-[10px] font-mono tracking-[0.25em] text-[#9a8f80] uppercase">AUTOMATIC SOURCING</span>
                    <h2 className="font-display text-2xl md:text-3xl text-[#e5e2e1]">Active Botanical Subscriptions</h2>
                  </div>
                  ...
                  <div className="space-y-6">
                    {subscriptions.map(sub => {
                      ...
                      return (
                        <div key={sub.id} className="p-6 bg-[#1e1e1e] rounded-lg border border-[#4d4639]/15 flex flex-col lg:flex-row lg:items-center gap-6 justify-between">
                          <div className="flex items-start gap-5">
                            <img 
                              src={sub.image} 
                              alt={sub.name} 
                              className="w-20 h-20 rounded object-cover filter brightness-90 border border-[#4d4639]/25"
                            />
                            <div className="space-y-1">
                              <div className="flex items-center gap-2">
                                <h3 className="text-sm font-bold text-[#e5e2e1] uppercase tracking-wider">{sub.name}</h3>
                              ...
                              <p className="text-[11px] text-[#d1c5b4] flex items-center gap-1 pt-1.5 font-mono">
                                <Calendar className="w-3.5 h-3.5 text-[#c8a45d]" /> Next Lunar Cycle refill: {sub.nextDelivery}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex flex-wrap items-center gap-3">
                            ...
                            <select 
                              ...
                              value={sub.frequency}
                              className="bg-[#111] border border-[#4d4639]/40 rounded text-xs font-mono text-[#d1c5b4] px-3 py-2 outline-none focus:ring-1 focus:ring-[#c8a45d]"
                            >
              ...
              {activeTab === 'wishlist' && (
                ...
                >
                  <div className="pb-4 border-b border-[#4d4639]/20">
                    ...
                    <h2 className="font-display text-2xl md:text-3xl text-[#e5e2e1]">Wishlist Sanctuary</h2>
                  </div>

                  {wishlistProducts.length === 0 ? (
                    <div className="py-16 text-center text-[#9a8f80] space-y-4">
                      <Heart className="w-10 h-10 text-[#4d4639] mx-auto opacity-40" />
                      <p className="text-xs tracking-wider uppercase font-mono">Your wishlist sanctuary lies in silent contemplation.</p>
                      <button 
                        onClick={() => setView('shop')}
                        className="bg-[#c8a45d] text-[#261900] px-6 py-2.5 rounded font-mono font-bold text-xs uppercase"
                      >
                        Browse Apothecary
                      </button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                      {wishlistProducts.map(prod => (
                        <div key={prod.id} className="bg-[#1e1e1e] rounded-lg border border-[#4d4639]/15 overflow-hidden flex flex-col h-full justify-between">
                          <img 
                            src={prod.image} 
                            alt={prod.name} 
                          ...
                          <div className="p-6 space-y-3 flex-grow flex flex-col justify-between">
                            <div>
                              <div className="flex justify-between items-start">
                                <h3 className="text-sm font-mono tracking-wider text-[#e5e2e1] uppercase font-bold">{prod.name}</h3>
                                <span className="text-xs font-bold text-[#e8c177]">{getPrice(prod, currency).formatted}</span>
                              </div>
                              <p className="text-xs text-[#d1c5b4] leading-relaxed mt-2 line-clamp-2">{prod.description}</p>
                            </div>
                            
                            <div className="flex gap-4 pt-4 border-t border-[#4d4639]/15">
                              <button 
                              ...
                              <button 
                                ...
                                className="px-3 border border-[#4d4639]/40 hover:border-red-400 text-[#9a8f80] hover:text-red-400 rounded py-2 transition-transform active:scale-95"
                              >
                                <X className="w-4 h-4" />
                              </button>
                            </div>
              ...
              {activeTab === 'settings' && (
                ...
                >
                  <div className="pb-4 border-b border-[#4d4639]/20">
                    ...
                    <h2 className="font-display text-2xl md:text-3xl text-[#e5e2e1]">Sanctuary Settings &amp; Preferences</h2>
                  </div>

                  {/* Profile Form */}
                  <div className="bg-[#1e1e1e] p-8 rounded-lg border border-[#4d4639]/15 space-y-6">
                    <h3 className="font-display text-lg text-[#e8c177] border-b border-[#4d4639]/20 pb-3 flex items-center gap-2">
                      <User className="w-5 h-5 text-[#c8a45d]" />
                      Profile Information
                    </h3>
                    ...
                    <form onSubmit={handleSaveChanges} className="space-y-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <input 
                            ...
                            className="w-full bg-[#111] border-b border-[#4d4639]/50 border-t-0 border-x-0 outline-none focus:border-[#c8a45d] text-[#e5e2e1] py-2 text-xs font-mono placeholder:text-[#4d4639]" 
                        ...
                        <div className="space-y-2">
                          ...
                          <input 
                            ...
                            className="w-full bg-[#111] border-b border-[#4d4639]/50 border-t-0 border-x-0 outline-none focus:border-[#c8a45d] text-[#e5e2e1] py-2 text-xs font-mono" 
                      ...
                      <div className="flex justify-end pt-4">
                        <button 
                          ...
                          className="bg-[#c8a45d] hover:bg-[#ffdea3] text-[#261900] px-8 py-3 rounded text-xs font-mono uppercase tracking-widest font-bold transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-45"
                        >
                  ...
                  <div className="bg-[#1e1e1e] p-8 rounded-lg border border-[#4d4639]/15 space-y-6">
                    <h3 className="font-display text-lg text-[#e8c177] border-b border-[#4d4639]/20 pb-3 flex items-center gap-2">
                      <Lock className="w-5 h-5 text-[#c8a45d]" />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input 
                          ...
                          className="w-full bg-[#111] border-b border-[#4d4639]/50 border-t-0 border-x-0 outline-none text-[#9a8f80] py-2 text-xs font-mono disabled:opacity-70"
                    ...
                    <div className="flex justify-end">
                      <button 
                        ...
                        className="bg-transparent border border-[#c8a45d] text-[#e8c177] hover:bg-[#c8a45d]/10 px-8 py-3 rounded text-xs font-mono uppercase tracking-widest font-normal cursor-pointer transition-colors"
                      >
                  ...
                  <div className="bg-[#1e1e1e] p-8 rounded-lg border border-[#4d4639]/15 space-y-6">
                    ...
                    <div className="space-y-6">
                      {/* Toggle 1 */}
                      <div className="flex items-center justify-between py-3 border-b border-[#4d4639]/20">
                        <div className="space-y-1">
                          <h4 className="text-sm font-medium text-[#e5e2e1] uppercase tracking-wider">Wellness Journal Updates</h4>
                        ...
                        >
                          <div 
                            className={`w-5 h-5 rounded-full bg-[#e8c177] shadow-md transform transition-transform duration-300 ${
                      ...
                      <div className="flex items-center justify-between py-3">
                        <div className="space-y-1">
                          <h4 className="text-sm font-medium text-[#e5e2e1] uppercase tracking-wider">Product Ritual Reminders</h4>
        ...
        {redeemModalOpen && (
          <div className="fixed inset-0 z-[120] bg-black/80 backdrop-blur-sm flex items-center justify-center p-6">
            <motion.div 
              ...
              className="bg-[#1e1e1e] border border-[#c8a45d]/40 rounded-lg max-w-lg w-full overflow-hidden shadow-2xl"
            >
              <div className="flex justify-between items-center bg-[#161514] px-6 py-4 border-b border-[#4d4639]/30">
                <h3 className="font-mono text-xs text-[#e8c177] font-semibold uppercase tracking-widest">Sattva Points - Redeem Wisdom</h3>
                <button onClick={() => setRedeemModalOpen(false)} className="text-[#9a8f80] hover:text-[#e5e2e1] cursor-pointer">
                  <X className="w-5 h-5" />
                </button>
              </div>
              <div className="p-6 space-y-6">
                <div className="text-center p-4 bg-[#111] rounded border border-[#4d4639]/20">
                  <span className="text-[10px] text-[#9a8f80] font-mono uppercase tracking-wider block">YOUR RITUAL BALANCE</span>
                  <div className="text-2xl font-display text-[#e8c177] mt-1 font-bold">{sattvaPoints} Prana Points</div>
                </div>

                <div className="space-y-3.5 max-h-[300px] overflow-y-auto pr-1">
                  {/* Reward 1 */}
                  <div className="flex justify-between items-center p-4 bg-[#111]/30 rounded border border-[#4d4639]/10 hover:border-emerald-500/30 transition-all">
                    <div>
                      <h4 className="text-xs font-semibold uppercase tracking-wider text-[#e5e2e1]">Free Sourced Logistics</h4>
                  ...
                  <div className="flex justify-between items-center p-4 bg-[#111]/30 rounded border border-[#4d4639]/10 hover:border-emerald-500/30 transition-all">
                    <div>
                      <h4 className="text-xs font-semibold uppercase tracking-wider text-[#e5e2e1]">Wellness Cart Discount</h4>
                  ...
                  <div className="flex justify-between items-center p-4 bg-[#111]/30 rounded border border-[#4d4639]/10 hover:border-emerald-500/30 transition-all">
                    <div>
                      <h4 className="text-xs font-semibold uppercase tracking-wider text-[#e5e2e1]">Free Sacred Rose Buds sampler Vague</h4>
        ...
        {activeTrackingOrder && (
          <div className="fixed inset-0 z-[120] bg-black/85 backdrop-blur-sm flex items-center justify-center p-6">
            <motion.div 
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.95, opacity: 0 }}
              className="bg-[#1e1e1e] border border-[#c8a45d]/40 rounded-lg max-w-xl w-full overflow-hidden shadow-2xl"
            >
              <div className="flex justify-between items-center bg-[#161514] px-6 py-4 border-b border-[#4d4639]/30">
                <div>
                  <h3 className="font-mono text-xs text-[#e8c177] font-semibold uppercase tracking-widest">Journey Tracker</h3>
                  <span className="text-[10px] text-[#9a8f80]">Order ID: #{activeTrackingOrder.id}</span>
                </div>
                <button onClick={() => setActiveTrackingOrder(null)} className="text-[#9a8f80] hover:text-[#e5e2e1] cursor-pointer">
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="p-8 space-y-8">
                ...
                <div className="relative pt-4 pb-2">
                  ...
                  {/* Active progress bar */}
                  <div 
                    className="absolute top-1/2 left-0 h-1 bg-gradient-to-r from-[#c8a45d] to-[#24523a] -translate-y-1/2 rounded-full transition-all duration-1000"
                  ...
                  <div className="relative flex justify-between items-center z-10">
                    ...
                    <div className="flex flex-col items-center">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-mono font-bold ${
                        activeTrackingOrder.trackingStep >= 0 ? 'bg-[#c8a45d] text-[#261900]' : 'bg-[#1e1e1e] border border-[#4d4639]/30 text-[#9a8f80]'
                      }`}>1</div>
                    ...
                    <div className="flex flex-col items-center">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-mono font-bold ${
                        activeTrackingOrder.trackingStep >= 1 ? 'bg-[#c8a45d] text-[#261900]' : 'bg-[#1e1e1e] border border-[#4d4639]/30 text-[#9a8f80]'
                      }`}>2</div>
                    ...
                    <div className="flex flex-col items-center">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-mono font-bold ${
                        activeTrackingOrder.trackingStep >= 2 ? 'bg-[#c8a45d] text-[#261900]' : 'bg-[#1e1e1e] border border-[#4d4639]/30 text-[#9a8f80]'
                      }`}>3</div>
                    ...
                    <div className="flex flex-col items-center">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-mono font-bold ${
                        activeTrackingOrder.trackingStep >= 3 ? 'bg-[#24523a] text-[#a0d2b3]' : 'bg-[#1e1e1e] border border-[#4d4639]/30 text-[#9a8f80]'
                      }`}>4</div>
                ...
                <div className="space-y-4 pt-4 border-t border-[#4d4639]/20">
                  <h4 className="text-xs font-mono uppercase tracking-widest text-[#e8c177]">Logistics Chronicles</h4>
                  <div className="space-y-4 text-xs">
                    {activeTrackingOrder.trackingStep >= 2 && (
                      <div className="flex gap-3">
                        <Truck className="w-4 h-4 text-emerald-400 shrink-0" />
                        <div>
                          <span className="font-semibold text-[#e5e2e1]">Parcel Handed to Luxury Carrier Vows</span>
                    ...
                    {activeTrackingOrder.trackingStep >= 1 && (
                      <div className="flex gap-3">
                        <Package className="w-4 h-4 text-[#e8c177] shrink-0" />
                        <div>
                          <span className="font-semibold text-[#e5e2e1]">Quality Assayed &amp; Sealed In Amber Glass</span>
                    ...
                    {activeTrackingOrder.trackingStep >= 0 && (
                      <div className="flex gap-3">
                        ...
                        <div>
                          <span className="font-semibold text-[#e5e2e1]">Himalayan Botanical Harvest Completed</span>
                ...
                <button 
                  ...
                  className="w-full bg-[#c8a45d] text-[#261900] text-xs font-mono uppercase tracking-widest font-bold py-3.5 rounded mt-4"
                >
                  Understood
                </button>
              </div>
