  ...
  return (
    <div className="min-h-screen bg-[#1A0F00] text-[#F5E4B0] pt-24 px-6 md:px-12 pb-20">
      <div className="max-w-7xl mx-auto">
        ...
        {error && (
          <div className="mt-6 bg-red-950/40 border border-red-400/30 text-red-100 rounded-lg p-4 text-sm">
            {error}
          </div>
        )}
                  ...
                  <section className="space-y-6">
                    <form onSubmit={createProduct} className="bg-[#3D2600] border border-[#C4A042]/30 rounded-lg p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <label className="space-y-2">
                        <span className="text-[10px] uppercase tracking-widest text-[#9a8f80]">Category</span>
                        <select
                      ...
                      <label className="md:col-span-2 space-y-2">
                        <span className="text-[10px] uppercase tracking-widest text-[#9a8f80]">Description</span>
                        <textarea
                        ...
                        <div key={product.databaseId || product.id} className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-4 p-4 border-b border-[#C4A042]/20 last:border-0">
                          <div className="flex gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-[#9a8f80] mt-1">{product.category} | Rs. {product.price} | Stock {product.stock ?? 0}</p>
                            </div>
                          </div>
