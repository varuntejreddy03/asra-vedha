...
export default function WisdomView({ setView }: WisdomViewProps) {
  return (
    <div className="bg-[#EDEDEC] text-[#2B2B2B] min-h-screen pt-12">
      {/* Hero Section */}
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden py-16 px-6 md:px-12 text-center bg-radial-[circle_at_top_right] from-[#1a2421] via-[#EDEDEC] to-[#EDEDEC]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          ...
          <motion.h1 
            ...
            className="font-display font-medium text-4xl md:text-6xl text-[#2B2B2B] mb-8 leading-[1.15] tracking-tight"
          >
            Rooted in Nature,<br />
          ...
          <motion.p 
            ...
            className="font-sans text-sm md:text-base text-[#6B6B6B] max-w-2xl leading-relaxed mb-12"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <img 
              ...
              className="w-full h-auto aspect-[4/5] object-cover rounded-md filter contrast-115 brightness-90 relative z-10 border border-[#C9A84C]/30"
          ...
          >
            ...
            <h2 className="font-display text-3xl md:text-5xl text-[#2B2B2B] mb-6 leading-tight">
              The Wisdom of <br />
              <span className="text-[#C9A84C] font-semibold italic">Asra Vedha</span>
            </h2>
            <p className="font-sans text-sm md:text-base text-[#6B6B6B] leading-relaxed mb-6">
            ...
            <button 
              ...
              className="self-start border border-[#C9A84C] text-[#C9A84C] px-8 py-3.5 rounded text-xs uppercase tracking-widest font-mono font-medium hover:bg-[#C9A84C]/10 transition-colors duration-300 cursor-pointer"
            >
              Enter Apothecary
            </button>
          </motion.div>
      ...
      <section className="py-20 bg-[#151515] border-y border-[#C9A84C]/20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            <span className="text-[#8C8C8C] text-xs font-mono tracking-widest uppercase mb-2 block">OUR CONSTITUTION</span>
            <h2 className="font-display text-3xl md:text-4xl text-[#2B2B2B]">Pillars of Practice</h2>
            <p className="font-sans text-xs md:text-sm text-[#8C8C8C] max-w-xl mx-auto mt-4 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div 
              ...
              className="bg-[#E5E4E2] p-8 md:p-10 rounded border border-[#C9A84C]/10 hover:border-[#C9A84C]/40 transition-all duration-500 relative overflow-hidden group"
            >
              ...
              <p className="font-sans text-xs md:text-sm text-[#6B6B6B] leading-relaxed relative z-10">
      ...
      <section className="py-20 md:py-32 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="bg-[#E5E4E2] rounded-lg overflow-hidden border border-[#C9A84C]/20 shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 md:p-16 lg:p-20 flex flex-col justify-center">
              ...
              <h2 className="font-display text-3xl md:text-4xl text-[#2B2B2B] mb-6 leading-tight">
                Nurturing the Roots
              </h2>
      ...
      {/* CTA Section */}
      <section className="py-24 px-6 md:px-12 text-center bg-gradient-to-b from-[#EDEDEC] to-[#0d0d0d] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
          ...
          <p className="font-sans text-sm md:text-base text-[#6B6B6B] mb-10 leading-relaxed">
          ...
          <button 
            onClick={() => setView('shop')}
            className="bg-[#C9A84C] hover:bg-[#B8963C] text-[#2B2B2B] px-8 py-4 rounded text-xs font-mono font-bold uppercase tracking-widest transition-all hover:scale-95 duration-300 inline-flex items-center gap-3 cursor-pointer shadow-lg shadow-[#C9A84C]/10"
          >
