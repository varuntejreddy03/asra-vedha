  ...
  return (
    <div className="min-h-screen bg-[#1A0F00] text-[#F5E4B0] pt-24 px-6 md:px-12 flex items-center justify-center relative overflow-hidden">
      ...
      <motion.div
        ...
        className="relative max-w-md w-full bg-[#3D2600]/90 border border-[#C4A042]/25 rounded-xl shadow-2xl overflow-hidden my-10"
      >
        ...
        <div className="p-7 md:p-8">
          ...
          <p className="text-center text-sm text-[#9a8f80] mt-7">
            ...
            <button onClick={() => setView('login')} className="text-[#C4A042] hover:text-[#d4b052] font-semibold cursor-pointer">
              Sign in
            </button>
          </p>
        </div>
